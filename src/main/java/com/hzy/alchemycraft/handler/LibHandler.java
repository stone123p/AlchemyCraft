...
public class LibHandler {
	...
	public static Object[][] Recipes={
			...
			/*29 生長之油*/		{ACItems.FullDistilledBottle,Item.getItemFromBlock(ACBlocks.Bruiseweed),Item.getItemFromBlock(ACBlocks.Earthroot),new ItemStack(Items.dye, 1, 15)},
		...
		public static String[][] Materials={
			...
			/*生長之油*/		{"gui.Bruiseweed_1.action","gui.Earthroot_1.action","gui.bonemeal_1.action"},
