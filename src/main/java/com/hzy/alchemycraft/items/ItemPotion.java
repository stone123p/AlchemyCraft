...
public class ItemPotion extends Item
{
    ...
    public static PotionEffect getEffects(ItemStack itemStack)
    {
    	...
    	if(item==  ACItems.FlyingPotion)potiones=new PotionEffect(ACPotions.Flying.id,10000,0);
    	if(item==  ACItems.LovePotion)potiones=new PotionEffect(ACPotions.Love.id,3600,0);
	...
	public ItemStack onItemUseFinish(ItemStack itemstack, World world, EntityPlayer player)
    {
        ...
        if (!world.isRemote)
        {
        	 PotionEffect potioneffect = ItemPotion.getEffects(itemstack);
