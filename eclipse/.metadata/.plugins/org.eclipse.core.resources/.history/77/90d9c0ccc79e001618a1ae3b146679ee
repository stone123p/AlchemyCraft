...
public class ACBlocks {
    ...
    //setting Others
    public static  Block Tripod =new Tripod(Material.iron);
    public static  Block Distiller = new Distiller(Material.iron);
    public static  Block Diffuser = new Diffuser(Material.rock);
    public static  Block AlchemyTable= new AlchemyTable(Material.rock);
    public static Block ACCauldron=new ACCauldron(Material.iron);
