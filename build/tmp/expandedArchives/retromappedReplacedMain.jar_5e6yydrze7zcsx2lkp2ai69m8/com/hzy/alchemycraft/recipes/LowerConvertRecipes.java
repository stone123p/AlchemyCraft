...
public LowerConvertRecipes(){
	...
	public Item getIngot(String MetalName){
		if(MetalName !="XXX"){
			...
			return OreDictionary.getOres("ingot"+MetalName).get(0).func_77973_b();
		}
		return null;
	}
	public ItemStack getPreciousMetals(String MetalName){
		if(MetalName !="XXX"){
			...
			if(ingotStack.func_77978_p()==null){
				ingotStack.func_77982_d(new NBTTagCompound());
			}
			NBTTagCompound nbt = new NBTTagCompound();
			nbt.func_74778_a("m","賦予靈氣：" + MetalName);
			ingotStack.func_77978_p().func_74782_a("metal", nbt);
			return  ingotStack ;
		}
		return null;
	}
	public ItemStack getIngot(ItemStack PreciousMetals){
		String I="ingot";
		if(PreciousMetals.func_77978_p() !=null){
			if(PreciousMetals.func_77978_p().func_74764_b("metal")){
				NBTTagCompound nbt = (NBTTagCompound) PreciousMetals.func_77978_p().func_74781_a("metal");
				List<ItemStack> FinElementList=OreDictionary.getOres(I.concat(nbt.func_74779_i("m").substring(5)));
