...
public class DistillerRecipes {
	...
	public static ItemStack[] RecipesList = {
			 ...
			 new ItemStack(ACItems.DistilledMaterialBottle[20]) , new ItemStack(ACItems.PsychePotion), 
			 new ItemStack(ACItems.DistilledMaterialBottle[21]) , new ItemStack(ACItems.FishOilBottle),
			 new ItemStack(ACItems.DistilledMaterialBottle[22]) , new ItemStack(ACItems.CorpseOilBottle),
			 new ItemStack(ACItems.DistilledMaterialBottle[23]) , new ItemStack(ACItems.WitherOilBottle),
			 new ItemStack(ACItems.DistilledMaterialBottle[24]) , new ItemStack(ACItems.WitherOilBottle),
			 new ItemStack(ACItems.DistilledMaterialBottle[25]) , new ItemStack(ACItems.YinYangOilBottle),
			 new ItemStack(ACItems.DistilledMaterialBottle[26]) , new ItemStack(ACItems.FireOilBottle),
			 new ItemStack(ACItems.DistilledMaterialBottle[27]) , new ItemStack(ACItems.FireOilBottle),
			 new ItemStack(ACItems.DistilledMaterialBottle[28]) , new ItemStack(ACItems.GrowthOilBottle),
			 new ItemStack(ACItems.DistilledMaterialBottle[29]) , new ItemStack(ACItems.ConversionOilBottle),
			 new ItemStack(ACItems.DistilledMaterialBottle[30]) , new ItemStack(ACItems.FrostOilBottle),
			 new ItemStack(ACItems.DistilledMaterialBottle[31]) , new ItemStack(ACItems.PoisonOilBottle),
			 new ItemStack(ACItems.DistilledMaterialBottle[32]) , new ItemStack(ACItems.ProdigyOilBottle),
	};
	...
	public ItemStack getSmeltingResult(ItemStack furnaceItemStacks,int index) {
		...
		for(int i=0;i<DistillerRecipes.RecipesList.length;i=i+2){
			if(furnaceItemStacks.func_77973_b()==RecipesList[i].func_77973_b()){
