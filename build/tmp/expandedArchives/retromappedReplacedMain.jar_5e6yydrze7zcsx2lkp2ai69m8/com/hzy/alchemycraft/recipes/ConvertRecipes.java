...
public class ConvertRecipes {
	...
	public static int getElementIndex(ItemStack itemStack){
		SetElements();
		String ElementName=new String(itemStack.func_77977_a());
		String I="",M="";
		...
		if(itemStack.func_77973_b()==Items.field_151114_aO)j=15;
		if(itemStack.func_77973_b()==Items.field_151044_h)j=6;
		return j;
	}
	public static ItemStack getFinElement(int i){
		...
		if(i<element.length){
			...
			if(!FinElementList.isEmpty()){
				return FinElementList.get(0).func_77946_l();
			}
		}
		return null;
	}
