...
public class ACBlocks {
    ...
    //setting Others
    public static  Block Tripod =new Tripod(Material.field_151576_e);
    public static  Block Distiller = new Distiller(Material.field_151576_e);
    public static  Block Diffuser = new Diffuser(Material.field_151576_e);
    public static  Block AlchemyTable= new AlchemyTable(Material.field_151576_e);
	...
	public static void registerRender(Block block){	
	    ...
	    .func_178086_a(Item.func_150898_a(block), 0, new ModelResourceLocation(AlchemyCraft.MODID+":"+block.func_149739_a().substring(5), "inventory"));	
	}
}
