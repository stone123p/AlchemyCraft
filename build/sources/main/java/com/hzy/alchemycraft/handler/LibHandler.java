...
public class LibHandler {
	...
	public static Object[][] Recipes={
			...
			/*20 迷幻之油*/		{ACItems.FullDistilledBottle,new ItemStack(ACItems.CorpseOilBottle.setContainerItem(Items.glass_bottle)),new ItemStack(ACItems.PoisonOilBottle.setContainerItem(Items.glass_bottle)),new ItemStack(ACItems.YinYangOilBottle)},
			/*21 魚   油*/		{ACItems.FullDistilledBottle,Items.fish},	
			/*22 屍   油*/		{ACItems.FullDistilledBottle,Items.bone,Items.rotten_flesh},
			/*23 凋零之油1*/		{ACItems.FullDistilledBottle,new ItemStack(ACItems.CorpseOilBottle.setContainerItem(Items.glass_bottle)),Items.nether_wart,Item.getItemFromBlock(ACBlocks.Kingsblood)},
			/*24 凋零之油2*/		{ACItems.FullDistilledBottle,new ItemStack(Items.skull, 1, 1)},
			/*25 陰陽之油*/		{ACItems.FullDistilledBottle,Item.getItemFromBlock(Blocks.yellow_flower),Item.getItemFromBlock(Blocks.brown_mushroom)},
			/*26 火焰之油1*/		{ACItems.FullDistilledBottle,Items.blaze_powder},
			/*27 火焰之油2*/		{ACItems.FullDistilledBottle,Item.getItemFromBlock(ACBlocks.Cinderpearl)},
			/*28 生長之油*/		{ACItems.FullDistilledBottle,Item.getItemFromBlock(ACBlocks.Bruiseweed),new ItemStack(Items.dye, 1, 15)},
			/*29 轉換之油*/		{ACItems.FullDistilledBottle,new ItemStack(ACItems.YinYangOilBottle.setContainerItem(Items.glass_bottle)),Item.getItemFromBlock(ACBlocks.Mageroyal)},
			/*30 冰霜之油*/		{ACItems.FullDistilledBottle,Item.getItemFromBlock(Blocks.ice),Item.getItemFromBlock(Blocks.snow)},
			/*31 邪毒之油*/		{ACItems.FullDistilledBottle,Items.spider_eye,Items.poisonous_potato,new ItemStack(Items.fish,1,3),Item.getItemFromBlock(ACBlocks.Briarthorn)},
			/*32 奪魂之油*/		{ACItems.FullDistilledBottle,Items.gunpowder,Items.gunpowder,Items.gunpowder,Items.gunpowder,Item.getItemFromBlock(ACBlocks.Peacebloom)}
		};
